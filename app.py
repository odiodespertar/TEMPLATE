...
NOMBRES_PLANES_C1_SJA1 = [
   "AEROPUERTO", "CANTERA", "DELICIAS", "GRANJAS", "MEOQUI", "NORTE", "SUR", "CUAUHTEMOC", "PARRAL", "ADICIONAL 1", "ADICIONAL 2", "ADICIONAL 3", "ADICIONAL 4", "ADICIONAL 5"
]
...
'''
    ...
    limite_tablas = 15  # range(1,21) = 20
