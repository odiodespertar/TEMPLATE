...
<script>
    ...
    function enviarConsultaBotLateral(opcionDirecta = null) {{
        ...
        if (q.includes("quitar") || q.includes("quitar unidades") || q.includes("ciclo 2") || q.includes("orh")) {{
            if (q.includes("scp1")) coincidenciasFaq.push(PREGUNTAS_FRECUENTES["scp1_cambios"]);
        }}
        ...
        // =========================================================================
        // 5. BÚSQUEDA EN DICCIONARIO REGLAS_RUTEO (SE EJECUTA SIEMPRE)
        // =========================================================================
        ...
        if (partesRespuesta.length > 0) {{
            ...
            respuestaFinal = "⚠️ No encontré esa consulta en la base de datos de <b>reglas.py</b>. Puedes consultar por un SVC (ej. SJA1, SCP1, SMD1, SGD2, SDD, Bulk, Alchichica) o presionar arriba para armar el resumen de cierre.";
        }}
